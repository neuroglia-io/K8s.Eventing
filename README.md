...
An open source .NET 5.0 implementation of a cloud event gateway for Kubernetes and Istio
...
We then took the decision to use the incredible possibilities [Kubernetes](https://kubernetes.io/) and [Istio](https://istio.io/) offer to make the [CloudEvent](https://github.com/cloudevents/spec) Gateway that could solve all of our problems, in the most simple way possible. 
